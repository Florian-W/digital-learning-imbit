...
(16, 'admin@brillianicm.com', 'Dorothea', 'Langer', '$shiro1$SHA-256$500000$DhdIuSNhEvqrvOmyfIfcuw==$AzmajwrcT/UxrYO50+zkTIFxjyazOhiiAY1xsSyPxBI=', 'admin', NULL, '2014-05-07 15:19:51', 0),
(17, 'dozent@brillianicm.com', 'Lukas', 'Steigerwald', '$shiro1$SHA-256$500000$DhdIuSNhEvqrvOmyfIfcuw==$AzmajwrcT/UxrYO50+zkTIFxjyazOhiiAY1xsSyPxBI=', 'professor', NULL, '2014-04-13 05:13:08', 1),
(18, 'student@brillianicm.com', 'Fred', 'Feuerstein', '$shiro1$SHA-256$500000$DhdIuSNhEvqrvOmyfIfcuw==$AzmajwrcT/UxrYO50+zkTIFxjyazOhiiAY1xsSyPxBI=', 'student', 3, '2014-04-21 14:45:32', 1),
(0, 'public@brillianicm.com', 'Public', 'Public', '$shiro1$SHA-256$500000$DhdIuSNhEvqrvOmyfIfcuw==$AzmajwrcT/UxrYO50+zkTIFxjyazOhiiAY1xsSyPxBI=', 'professor', NULL, '2014-04-21 14:45:32', 1);
...
-- <<Create Users>>
CREATE USER brillianicm@localhost identified by 'icm@IMBIT'; -- //TODO remove password
