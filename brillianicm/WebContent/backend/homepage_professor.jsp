...
<body class="easyui-layout" style="min-width: 768px">
	...
	<div class="center mainWindow" data-options="region:'center'"
		...
		<div id="studentsOfProfessor">
						...
						<%
							...
							if (request.getAttribute("groups") != null) {
								...
								for (int i = 0; i < groups.size(); i++) {//ArrayList<String> row : groups
									...
									out.println("<form action=\"" + webAppPath + "/RegistrationPage\" method=\"post\">"
									...
									*/
									...
									out.println("<td><form action=\"" + webAppPath + "/SendCertificate\" method=\"post\">"
									...
									if (groups.get(i).get(2).equals("1")) {
										out.println("<td><form action=\"" + webAppPath + "/ChangeCertificate\" method=\"post\">"
			...
			<div
				style="height: 350px; text-align: left; width: 80%; background-color: white; border-width: 1px; border-style: solid; border-color: black; padding-bottom: 2%">
