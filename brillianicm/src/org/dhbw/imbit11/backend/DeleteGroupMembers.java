...
/**
 * When a professor deletes a group with all its members this class is invoked
 * 
 * @author Fred
 *
 */
 public class DeleteGroupMembers extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			 realm.deleteGroupMembers(group_id);
