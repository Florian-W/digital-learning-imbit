							...
							if (request.getAttribute("groups") != null) {
								...
								for (int i = 0; i < groups.size(); i++) { //ArrayList<String> row : groups
									...
									out.println("<form action=\"" + application.getContextPath() + "/SetUserProgress\" method=\"post\">"
											...
											+ "<option value=\"l201e000\">Work Breakdown Structure</option>" + "</select>"
									...
									if (request.getAttribute("students") != null) {
										...
										if (studentsFiltered.isEmpty()) {
											...
											out.println(
													"<table id=\"students\" class=\"easyui-datagrid\" style=\"width: 800px\" data-options=\"fitColumns:true,singleSelect:true\">"
					...
					<div style="text-align: left; width: 80%; background-color: white; border-width: 1px; border-style: solid; border-color: black; padding-bottom: 2%; height: 100%">
						<div style="width: 50%; float: left; padding-left: 5%">
							...
							<form action="NewUsergroup" method="post">
								...
								<input type="submit" style="display: none" id="createGroup"
						...
						<div style="margin-left: 50%; padding-left: 5%">
							...
							<form action="ResetPassword" method="post">
								<input type="text" name="username" maxlength="50"
									value="${username}" style="display: none" /> <input
									type="text" name="role" maxlength="50" value="professor"
									style="display: none" />
								...
								<input style="width: 200px" type="password"
									name="password_repeat" maxlength="50" /><br /> <br /> <input
									id="updatePassword" type="submit" name="updatePassword"
									value="Update password" hidden="hidden" /> <a
									class="easyui-linkbutton"
