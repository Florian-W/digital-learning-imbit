...
public interface ApplicationConstants {
	...
	public static  String PANEL_EAST_TITLE = "Status";
	
	public static  String LOCATION1_NAME = "Airport";
	public static  String LOCATION2_NAME = "Public Transport";
	public static  String LOCATION3_NAME = "Office";
