	...
	if ( $('#source').children().length == 0 ){
		...
		for(var i=0; i<counter; i++){
			...
			/*
			 ...
			 Wenn das Element sich nicht in dem Container befindet, wird der Hintergrund rot
			*/
			if(document.getElementById("d"+i).title == "target1"){
				if ($(document.getElementById("d"+i)).parents("#target1").length == 1){
					document.getElementById("d"+i).style.backgroundColor ="#AACCFF";
				}else{
	 ...
	 alert("You have not dragged all items");	
	}