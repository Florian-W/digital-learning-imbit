...
var modal_interaktive_whiteboards = document.getElementById('modal');
...
btn_interaktive_whiteboards.onclick = function() {
    modal_interaktive_whiteboards.style.display = "block";
};

// When the user clicks on <span> (x), close the modal
span.onclick = function() {
    modal_interaktive_whiteboards.style.display = "none";
};

// When the user clicks anywhere outside of the modal, close it
window.onclick = function(event) {
    if (event.target == modal_interaktive_whiteboards) {
        modal_interaktive_whiteboards.style.display = "none";
    }
};
